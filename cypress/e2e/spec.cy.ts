...
describe('Domain Name Generator', () => {
	const testCases = [
		...
		// adguard-home-dns-crypt.ix-adguard-home.svc.cluster.local                           5443/TCP
		{
			...
			portNumber: 5443,
			expectedDomain:
				'adguard-home-dns-crypt.ix-adguard-home.svc.cluster.local:5443',
		},
		// adguard-home-dns-crypt-udp.ix-adguard-home.svc.cluster.local                       5443/UDP
		{
			...
			portNumber: 5443,
			expectedDomain:
				'adguard-home-dns-crypt-udp.ix-adguard-home.svc.cluster.local:5443',
		},
		// adguard-home-dns-https.ix-adguard-home.svc.cluster.local                           10234/TCP
		{
			...
			portNumber: 10234,
			expectedDomain:
				'adguard-home-dns-https.ix-adguard-home.svc.cluster.local:10234',
		},
		// adguard-home-dns-https-udp.ix-adguard-home.svc.cluster.local                       10234/UDP
		{
			...
			portNumber: 10234,
			expectedDomain:
				'adguard-home-dns-https-udp.ix-adguard-home.svc.cluster.local:10234',
		},
		// adguard-home-dns-quic-udp-1.ix-adguard-home.svc.cluster.local                      784/UDP,853/UDP,8853/UDP
		{
			...
			portNumber: 784,
			expectedDomain:
				'adguard-home-dns-quic-udp-1.ix-adguard-home.svc.cluster.local:784',
		},
		// adguard-home-dns-tcp.ix-adguard-home.svc.cluster.local                             53/TCP
		{
			...
			portNumber: 53,
			expectedDomain:
				'adguard-home-dns-tcp.ix-adguard-home.svc.cluster.local:53',
		},
		// adguard-home-dns-udp.ix-adguard-home.svc.cluster.local                             53/UDP
		{
			...
			portNumber: 53,
			expectedDomain:
				'adguard-home-dns-udp.ix-adguard-home.svc.cluster.local:53',
		},
		...
		// cert-manager-certmanager.ix-cert-manager.svc.cluster.local                         9402/TCP
		{
			...
			portNumber: 9402,
			expectedDomain:
				'cert-manager-certmanager.ix-cert-manager.svc.cluster.local:9402',
		},
		// cert-manager-certmanager-webhook.ix-cert-manager.svc.cluster.local                 443/TCP
		{
			...
			portNumber: 443,
			expectedDomain:
				'cert-manager-certmanager-webhook.ix-cert-manager.svc.cluster.local:443',
		},
		...
		// external-service.ix-external-service.svc.cluster.local                             444/TCP
		{
			...
			portNumber: 444,
			expectedDomain:
				'external-service.ix-external-service.svc.cluster.local:444',
		},
		...
		// fireflyiii-cnpg-main-pooler-rw.ix-fireflyiii.svc.cluster.local                     5432/TCP
		{
			...
			portNumber: 5432,
			expectedDomain:
				'fireflyiii-cnpg-main-pooler-rw.ix-fireflyiii.svc.cluster.local:5432',
		},
		// fireflyiii-cnpg-main-r.ix-fireflyiii.svc.cluster.local                             5432/TCP
		{
			...
			portNumber: 5432,
			expectedDomain:
				'fireflyiii-cnpg-main-r.ix-fireflyiii.svc.cluster.local:5432',
		},
		// fireflyiii-cnpg-main-ro.ix-fireflyiii.svc.cluster.local                            5432/TCP
		{
			...
			portNumber: 5432,
			expectedDomain:
				'fireflyiii-cnpg-main-ro.ix-fireflyiii.svc.cluster.local:5432',
		},
		// fireflyiii-cnpg-main-rw.ix-fireflyiii.svc.cluster.local                            5432/TCP
		{
			...
			portNumber: 5432,
			expectedDomain:
				'fireflyiii-cnpg-main-rw.ix-fireflyiii.svc.cluster.local:5432',
		},
		...
		// fireflyiii-data-importer-custom-app.ix-fireflyiii-data-importer.svc.cluster.local  10083/TCP
		{
			...
			portNumber: 10083,
			expectedDomain:
				'fireflyiii-data-importer-custom-app.ix-fireflyiii-data-importer.svc.cluster.local:10083',
		},
		...
		// maintainerr-custom-app.ix-maintainerr.svc.cluster.local                            8154/TCP
		{
			...
			portNumber: 8154,
			expectedDomain:
				'maintainerr-custom-app.ix-maintainerr.svc.cluster.local:8154',
		},
		...
		// qbittorrent-gluetun.ix-qbittorrent.svc.cluster.local                               8000/TCP
		{
			...
			portNumber: 8000,
			expectedDomain:
				'qbittorrent-gluetun.ix-qbittorrent.svc.cluster.local:8000',
		},
		// qbittorrent-torrent.ix-qbittorrent.svc.cluster.local                               6881/TCP,6881/UDP
		{
			...
			portNumber: 6881,
			expectedDomain:
				'qbittorrent-torrent.ix-qbittorrent.svc.cluster.local:6881',
		},
		...
		// qbittorrent-2-gluetun.ix-qbittorrent-2.svc.cluster.local                       8000/TCP
		{
			...
			portNumber: 8000,
			expectedDomain:
				'qbittorrent-2-gluetun.ix-qbittorrent-2.svc.cluster.local:8000',
		},
		// qbittorrent-2-torrent.ix-qbittorrent-2.svc.cluster.local                       6882/TCP,6882/UDP
		{
			...
			portNumber: 6882,
			expectedDomain:
				'qbittorrent-2-torrent.ix-qbittorrent-2.svc.cluster.local:6882',
		},
		...
		// syncthing-discovery.ix-syncthing.svc.cluster.local                                 21027/UDP
		{
			...
			portNumber: 21027,
			expectedDomain:
				'syncthing-discovery.ix-syncthing.svc.cluster.local:21027',
		},
		// syncthing-listeners.ix-syncthing.svc.cluster.local                                 22000/TCP
		{
			...
			portNumber: 22000,
			expectedDomain:
				'syncthing-listeners.ix-syncthing.svc.cluster.local:22000',
		},
		// syncthing-listeners-udp.ix-syncthing.svc.cluster.local                             22000/UDP
		{
			...
			portNumber: 22000,
			expectedDomain:
				'syncthing-listeners-udp.ix-syncthing.svc.cluster.local:22000',
		},
	...
	testCases.forEach((testCase) => {
		it(`Generates domain name correctly for a service with catalog app name '${testCase.catalogAppName}', custom app name '${testCase.customAppName || ''}', service name '${testCase.serviceName || ''}', and port number '${testCase.portNumber || ''}'`, () => {
			...
			cy.get('#output')
				.should('exist')
				.invoke('text')
				.should('eq', testCase.expectedDomain);
		});
	});
});
